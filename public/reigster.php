...
<head>
    ...
    <title>Registrierung - MiniFeed</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <form action="reigster.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="password" id="password" name="password" placeholder="Mindestens 6 Zeichen" required>
            </div>
        ...
        <div class="login-link">
            <a href="index.php">Bereits registriert? Zum Login</a>
        </div>
    </div>
</body>
